        ...
        extends RangerAccessResourceImpl
{
    ...
    public static RangerPrestoAccessResource getDatabase(String catalogName, String databaseName)
    {
        Map<String, Object> elements = new HashMap<>();
        elements.put(KEY_CATALOG, catalogName);
        elements.put(KEY_DATABASE, databaseName);
        return new RangerPrestoAccessResource(elements);
    }

    public static RangerPrestoAccessResource getTable(String catalogName, String databaseName, String tableName)
    {
        Map<String, Object> elements = new HashMap<>();
        elements.put(KEY_CATALOG, catalogName);
        elements.put(KEY_DATABASE, databaseName);
        elements.put(KEY_TABLE, tableName);
        return new RangerPrestoAccessResource(elements);
    }
